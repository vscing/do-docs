...
- 参数:
  ...
  **percentX** |<font color ='#808000'>**number**</font> | 50 | 否|相对于图片大小的一个百分比位置
  **percentY** |<font color ='#808000'>**number**</font> | 50 | 否|相对于图片大小的一个百分比位置
  **fontColor** |<font color ='#808000'>**string**</font> | 000000FF | 否|设置字体显示颜色，值格式为：8位16进制字符，前6位是RGB颜色值，后两位是透明度（Alpha），例如：000000FF
