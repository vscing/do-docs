...
- 参数:
  ...
  名称 | 类型 |是否必填|缺省值|说明
  ---- |-------------  |--------------|--------|------
  **duration** |<font color ='#808000'>**number**</font> | 1000 | 否|振动持续时间，单位是毫秒，iOS平台不支持设置振动时间
...
- 参数:
  ...
  名称 | 类型 |是否必填|缺省值|说明
  ---- |-------------  |--------------|--------|------
  **isAuto** |<font color ='#808000'>**Boolean**</font> | true | 否|为true时与系统设置保持一致，到了系统设置的自动锁屏时间则自动熄灭屏幕并锁屏；为false时则屏幕常亮，且不锁屏
- 返回值类型 : <font color ='#808000'>**无**</font>
- 返回值描述: 无
- 说明: 控制系统锁屏
- 示例:
