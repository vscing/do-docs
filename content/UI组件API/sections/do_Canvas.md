...
- 参数:
  ...
  **start** |<font color ='#808000'>**object**</font> |  | 是||左上坐标，如：{x:x坐标,x:y坐标}
  **end** |<font color ='#808000'>**object**</font> |  | 是||右下坐标，如：{x:x坐标,x:y坐标}
  **startAngle** |<font color ='#808000'>**number**</font> | 0 | 否|0|如果为0默认与x轴重合
  **sweepAngle** |<font color ='#808000'>**number**</font> | 90 | 否|90|默认为90，以起始角度开始，顺时针扫描90度
  **useCenter** |<font color ='#808000'>**Boolean**</font> | true | 否|true|如果为true，这个弧的区域就会包含中心点
- 返回值类型 : <font color ='#808000'>**无**</font>
- 返回值描述: 无
- 说明: 
- 示例:
...
- 参数:
  ...
  **coord** |<font color ='#808000'>**object**</font> | {x:0,y:0} | 否|{x:0,y:0}|从此坐标开始画，如：{x:x坐标,x:y坐标}
  ...
  **textAlign** |<font color ='#808000'>**string**</font> | left | 否|left|对齐方式为以下3种：left 左对齐（默认）；center 居中；right 右对齐。
  **angle** |<font color ='#808000'>**number**</font> | 0 | 否|0|如果为0默认与x轴重合
- 返回值类型 : <font color ='#808000'>**无**</font>
- 返回值描述: 通过左上坐标与右下坐标定义一个矩形
- 说明: 
- 示例:
