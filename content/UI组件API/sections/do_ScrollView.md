...
>###### <font color ='#42b983'>**direction**</font>: 滚动方向

- 数据类型 : <font color ='#808000'>**string**</font>
- 默认值 : vertical
- 说明 : 设置视图滚动方向值，支持两种类型：horizontal（横向）、vertical（纵向）

>###### <font color ='#42b983'>**isShowbar**</font>: 显示滚动条

- 数据类型 : <font color ='#808000'>**boolean**</font>
- 默认值 : false
- 说明 : 为true的时候，当scrollview内内容超出scrollview的边界，会出现滚动条标识

>###### <font color ='#42b983'>**headerView**</font>: 顶部视图
...
>##### <font color ='#0092db'>**toBegin**</font>: 滚到到最前
...
>##### <font color ='#0092db'>**toEnd**</font>: 滚到到最后
...
>##### <font color ='#0092db'>**rebound**</font>: 顶部视图复位
...
>##### <font color ='#0092db'>**scrollTo**</font>: 滚动到指定位置

- 参数:

  名称 | 数据类型 |默认值|是否必填|缺省值|说明
  ---- |-------------  |----------|--------------|--------|------
  **offset** |<font color ='#808000'>**number**</font> | 0 | 否|0|
- 返回值类型 : <font color ='#808000'>**无**</font>
- 返回值描述: 无
